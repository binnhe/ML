**“从样例中学习”（也就是广义的归纳学习），它涵盖了监督学习、无监督学习等，《机器学习》（本书）大部分内容属此范畴。**

## 第一章  绪论

下足了工夫、弄清了概念、做好了作业，希望能真正学懂 machine learning！

### 1.1 机器学习的定义

**机器学习**所研究的主要内容，是关于计算机上从数据中产生“模型”（model）的算法，即“学习算法”（learning algorithm）。
**机器学习**是研究关于“学习算法”的学问。
